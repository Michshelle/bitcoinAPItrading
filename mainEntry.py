...
#public info test
#test the interface of get BitCoin-US Dollar bid information, include:
#bid, ask, price, volumn, daily high, daily low etc.
...
#Authenticated information test, include:
#1. wallet
#2. order history
tmpParas = ''
...
secSignature = "/api/"+tmpSrvPath+tmpNonce+rawBody
tmpH = hmac.new(passName.encode(), secSignature.encode(), hashlib.sha384)
